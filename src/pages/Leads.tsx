  ...
  return (
      <div className="min-h-screen bg-background ">
        ...
        <Dialog open={showConvertModal} onOpenChange={setShowConvertModal}>
          <DialogContent className="max-w-3xl w-full p-0 mx-2 sm:mx-8">
            {convertStep === "form" ? (
              <>
                ...
                <form className="divide-y divide-gray-200" onSubmit={e => { e.preventDefault(); setConvertStep("success"); }}>
                  {/* Account Section */}
              ...
              <div className="flex flex-col items-center justify-center py-8 px-4">
                ...
                <div className="w-full flex justify-end items-center gap-3 px-8 pb-4">
                  ...
                  <button className="px-5 py-2 rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-700" onClick={() => setShowConvertModal(false)}>Go to Leads</button>
                </div>
              </div>
            )}
          </DialogContent>
                ...
                return (
                  <tr key={lead.id || idx} className="border-b hover:bg-muted/30">
                    ...
                    <td className="p-2 font-medium">
                      <button 
                        onClick={() => handleLeadClick(lead, idx)}
                    ...
                    <td className="p-2">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => handleLeadClick(lead, idx)}>
